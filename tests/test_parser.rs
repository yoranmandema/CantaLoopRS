...
#[test]
fn test_parse_if_statement_no_parens() {
    assert_parse_success(r#"
if true {
    x = 1;
}
...
#[test]
fn test_parse_if_else_statement_no_parens() {
    assert_parse_success(r#"
if x == 1 {
    let y = 2;
} else {
...
#[test]
fn test_parse_if_elseif_statement_no_parens() {
    assert_parse_success(r#"
if x == 1 {
    let y = 2;
} elseif x == 2 {
...
fn test_parse_invalid_syntax_should_fail() {
    ...
    assert_parse_failure("x = 5"); // Missing semicolon
    assert_parse_failure("let x = 5"); // Missing semicolon
    assert_parse_failure("return 5"); // Missing semicolon
